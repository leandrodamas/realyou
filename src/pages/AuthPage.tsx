...
const AuthPage: React.FC = () => {
  ...
  // Verificar se há parâmetros de erro na URL (redirecionamento do Google)
  useEffect(() => {
    ...
    if (error) {
      ...
      setAuthError(`Erro de autenticação: ${errorDescription || error}`);
          ...
          <CardContent>
            ...
            <form onSubmit={handleAuth} className="space-y-4">
              ...
              <Button 
                ...
                disabled={isLoading || isSubmitting || isGoogleSubmitting}
              >
                {isSubmitting ? (
                  <>
            ...
            <div className="mt-5">
              ...
              <p className="mt-3 text-xs text-center text-gray-500">
                Certifique-se de que os popups não estão bloqueados para o login com Google.
              </p>
            </div>
          </CardContent>
        </Tabs>
